...
namespace Owl_learn_Blokboek5
{
    ...
    /// </summary>
    public sealed partial class VerwijderLesonderwerp : Page
    {
        //VARIABELEN
        ...
        private async void btAccept_Click(object sender, RoutedEventArgs e)
        {
            ...
            HttpResponseMessage deleteVak = await connect.GetAsync("http://localhost/Leerjaar2/OP3/Owl-learn/functies/ConsulentDashboard/verwijderLO.php?loID=" + loid);
            ...
            if (resultaat == "failed")
            {
                ...
                var dialog1 = new MessageDialog("Er is iets missgegaan met het verwijderen van het lesonderwerp", "Foutmelding");
                await dialog1.ShowAsync();
            }
            else
            {
                var dialog1 = new MessageDialog("Het lesonderwerp is succesvol verwijdert, u wordt nu teruggestuurd naar de vorige pagina.", "Succes!");
                await dialog1.ShowAsync();
